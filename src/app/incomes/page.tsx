...
import { INCOME_COLOR, colorForSlug, slotIndex } from "@/lib/chart-colors";
...
export default async function IncomesPage({
  ...
  const buildQuery = () => {
    ...
    if (period.de) query = query.gte("received_at", period.de);
    if (period.ate) query = query.lte("received_at", period.ate);
    return query
